...
;(function ($, window) {
  ...
  var CONSTANTS = {
    ...
    SCROLL_OFFSET_FRACTION: 1, // each click moves the container this fraction of the fixed container--decrease
  ...
  $.fn.scrollingTabs.defaults = {
    ...
    cssClassLeftArrow: 'tableft_arrow',
    cssClassRightArrow: 'tabright_arrow',
    leftArrowContent: '',
    rightArrowContent: '',
    enableSwiping: false,
